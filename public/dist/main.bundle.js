...
var InsertData_1 = __webpack_require__(5);
...
Object.defineProperty(exports, "__esModule", { value: true });
var value_types_1 = __webpack_require__(0);
var MentionSanitizer_1 = __webpack_require__(14);
...
var _quillDeltaToHtml = __webpack_require__(11);

var _quillDeltaToHtml2 = _interopRequireDefault(_quillDeltaToHtml);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var quillToolbar = [['bold', 'italic', 'underline', 'strike'], // toggled buttons
...
function getActiveNavLink() {
  if (/about/.test(window.location.pathname)) {
    return (0, _jquery2.default)('#nav-about');
  } else if (/contact/.test(window.location.pathname)) {
    return (0, _jquery2.default)('#nav-contact');
  } else if (/category/.test(window.location.href)) {
    return (0, _jquery2.default)('#nav-categories');
  } else {
    return (0, _jquery2.default)('#nav-home');
  }
}
...
(0, _jquery2.default)(document).ready(function () {
  ...
  if (window.location.pathname !== '/' || getURLParameter('page') !== null && +getURLParameter('page') !== 1) {
    var offset = (0, _jquery2.default)('#nav').offset().top;
    if (offset > window.scrollY) (0, _jquery2.default)('html, body').animate({ scrollTop: (0, _jquery2.default)('#nav').offset().top }, 500); //.scrollTop(window.innerHeight);
  }

  (0, _jquery2.default)('#chevron-down').click(function () {
    var offset = (0, _jquery2.default)('#nav').offset().top;
    (0, _jquery2.default)('html, body').animate({ scrollTop: offset }, 750);
  });

  (0, _jquery2.default)('#nav-slider').css({ left: getActiveNavLink().position().left, width: getActiveNavLink().outerWidth() });

  (0, _jquery2.default)('.nav__link--text').each(function () {
    var self = (0, _jquery2.default)(this);
    self.hover(function () {
      (0, _jquery2.default)('#nav-slider').stop().animate({ left: self.position().left, width: self.outerWidth() }, 125);
    }, function () {
      var link = getActiveNavLink();
      (0, _jquery2.default)('#nav-slider').stop().animate({ left: link.position().left, width: link.outerWidth() }, 125);
    });
  });

  if (window.location.pathname === '/' || window.location.pathname === '/posts') {
    (0, _jquery2.default)('#page-slider').css({ left: (0, _jquery2.default)('#active-page').position().left + 8 });

    (0, _jquery2.default)('.pagination__button').each(function () {
      var self = (0, _jquery2.default)(this);
      self.hover(function () {
        (0, _jquery2.default)('#page-slider').stop().animate({ left: self.position().left + 8 }, 250);
      }, function () {
        var active = (0, _jquery2.default)('#active-page');
        (0, _jquery2.default)('#page-slider').stop().animate({ left: active.position().left + 8 }, 250);
      });
    });
  }

  window.toggleLoginForm = function () {
    (0, _jquery2.default)('#login-form').toggleClass('login-form--show');
  };

  if ((0, _jquery2.default)('#new-post-preview').length) {
    ...
    editor.on('text-change', function () {
      ...
      var qdc = new _quillDeltaToHtml2.default(delta.ops, window.opts_ || {});
      var html = qdc.convert();
      (0, _jquery2.default)('#post-preview').html(html);
      (0, _jquery2.default)('#hidden-preview').val(html);
      MathJax.Hub.Queue(['Typeset', MathJax.Hub]);
    });
  }

  if ((0, _jquery2.default)('#new-post-body').length) {
    var _editor = new Quill('#new-post-body', {
      modules: {
        toolbar: quillToolbar
      },
      theme: 'snow'
    ...
    _editor.on('text-change', function () {
      var delta = _editor.getContents();
      var qdc = new _quillDeltaToHtml2.default(delta.ops, window.opts_ || {});
      var html = qdc.convert();
      (0, _jquery2.default)('#post-body').html(html);
      (0, _jquery2.default)('#hidden-body').val(html);
      MathJax.Hub.Queue(['Typeset', MathJax.Hub]);
    });
  }
});
...
var QuillDeltaToHtmlConverter_1 = __webpack_require__(12);
module.exports = QuillDeltaToHtmlConverter_1.QuillDeltaToHtmlConverter;
...
Object.defineProperty(exports, "__esModule", { value: true });
var InsertOpsConverter_1 = __webpack_require__(13);
var OpToHtmlConverter_1 = __webpack_require__(16);
var Grouper_1 = __webpack_require__(17);
var group_types_1 = __webpack_require__(3);
var ListNester_1 = __webpack_require__(18);
var funcs_html_1 = __webpack_require__(7);
...
Object.defineProperty(exports, "__esModule", { value: true });
var DeltaInsertOp_1 = __webpack_require__(4);
var value_types_1 = __webpack_require__(0);
var InsertData_1 = __webpack_require__(5);
var OpAttributeSanitizer_1 = __webpack_require__(6);
var InsertOpDenormalizer_1 = __webpack_require__(15);
