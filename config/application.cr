...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Sam Blog web application."
  #
  #
  ...
  #
  # settings.secret_key_base= OjBv5WZnTTku5VQEG3iBkvdEdNR9VeWJp_N0goC3JIk
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("sam-blog.log", "w"))
  #
  #
end
